...
const ScrollableTabBar = createReactClass({
	...
	renderTab(
		...
		if (typeof name === "string") {
			return (
				<Button key={`${name}_${page}`} onPress={() => onPressHandler(page)} onLayout={onLayoutHandler} style={this.props.tabHeadingButtonStyle}>
			...
			return (
				<Button key={_.random(1.2, 5.2)} onPress={() => onPressHandler(page)} onLayout={onLayoutHandler} style={this.props.tabHeadingButtonStyle}>
